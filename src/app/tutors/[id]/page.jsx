            ...
            <div className="fixed inset-0 z-50 overflow-y-auto">
                <div className="flex min-h-full items-center justify-center p-4 py-8">
                    ...
                    >
                        {/* 
                            KEY FIXES:
                            - bg-white dark:bg-zinc-900  →  solid background, no bleed-through
                            - border-zinc-200 dark:border-zinc-700  →  visible border
                            - shadow-2xl  →  lifts modal off the page
                        */}
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                onChange={e => setPhone(e.target.value)}
                                                placeholder="+880 1XXX-XXXXXX"
                                                className="w-full rounded-2xl border border-zinc-200 bg-zinc-50 py-3 pl-11 pr-4 text-sm text-zinc-900 placeholder-zinc-400 outline-none transition focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100 dark:border-zinc-700 dark:bg-zinc-800 dark:text-white dark:placeholder-zinc-500 dark:focus:border-indigo-500 dark:focus:ring-indigo-900/40"
                                            />
                                        </div>
                                    </div>
