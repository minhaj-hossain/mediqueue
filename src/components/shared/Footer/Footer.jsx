...
const Footer = () => {
    return (
        <footer className="border-t border-foreground/5 bg-background pt-24 pb-12">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid gap-x-20 gap-y-16 md:grid-cols-2 lg:grid-cols-4">
                    <div className="space-y-8">
                        <Link href="/" className="flex items-center gap-2">
                            ...
                            <span className="text-lg font-display font-black tracking-tight text-foreground">
                        ...
                        <div className="flex gap-6">
                            <a href="#" className="text-foreground/20 transition-colors hover:text-teal-accent">
                    ...
                    <div>
                        <h4 className="mb-8 text-[10px] font-foreground uppercase tracking-[0.2em] text-foreground">Solutions</h4>
                        <ul className="space-y-4 text-xs font-bold text-foreground/40 uppercase tracking-widest">
                    ...
                    <div>
                        <h4 className="mb-8 text-[10px] font-foreground uppercase tracking-[0.2em] text-foreground">Platform</h4>
                        <ul className="space-y-4 text-xs font-bold text-foreground/40 uppercase tracking-widest">
                    ...
                    <div>
                        <h4 className="mb-8 text-[10px] font-foreground uppercase tracking-[0.2em] text-foreground">Contact</h4>
                        <ul className="space-y-4 text-xs font-bold text-foreground/40 uppercase tracking-widest">
                ...
                <div className="mt-24 border-t border-foreground/5 pt-12 flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex gap-8">
                        <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-foreground/10">Status: Operational</span>
                        <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-foreground/10">v2.0.4</span>
                    </div>
                </div>
            </div>
        </footer>
